...
import com.razitulikhlas.banknagari.databinding.ActivityMapsRumahBinding
...
class MapsRumahActivity : AppCompatActivity() , OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityMapsRumahBinding
...
//            val img1 = prepareFilePart("image1", images1, this)
            ...
            lifecycleScope.launch {
                viewModel.insertHome(
                    dataImage,
                    prepareFilePart("image1", images1, this@MapsRumahActivity),
                    prepareFilePart("image2", images2, this@MapsRumahActivity),
                    prepareFilePart("image3", images3, this@MapsRumahActivity),
                    prepareFilePart("image4", images4, this@MapsRumahActivity),
                ).observeForever {
                    when (it) {
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
                ...
                locationClient
                    ...
                    .onEach { location ->
                        serviceScope.launch(Dispatchers.Main) {
                            ...
                            Log.e("tag", "latitude:$latitude,longi:$longitude")
                            ...
                            val geocode = Geocoder(this@MapsRumahActivity,local)
                ...
                when ((it as ApiException).statusCode) {
                    LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> {
                        try {
                            ...
                            re.startResolutionForResult(this@MapsRumahActivity,  0x1)
                        } catch (sie: IntentSender.SendIntentException) {
                            Log.e("TAG", "Error")
                        }
                    }
                    LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE -> {
                        val alertDialog = AlertDialog.Builder(this@MapsRumahActivity)
    ...
    private fun clearImage() {
        with(binding) {
            cv1.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv2.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv3.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv4.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv5.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv6.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv7.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
            cv8.strokeColor = ContextCompat.getColor(this@MapsRumahActivity, R.color.normal)
